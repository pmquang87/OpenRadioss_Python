"""M4 contact validations: /INTER/TYPE24 full options, /INTER/TYPE2 tied,
...
from pyradioss.contact import ContactType2, ContactType24, ContactType11
...
# ============================================================================
# Unit tests — TYPE24 penalty force at a known penetration
# ============================================================================

def test_type24_penalty_force_closed_form(make_deck):
...
def test_type24_igap_variable_gap(make_deck):
...
def test_type24_self_impact_candidates(make_deck):
...
def test_type24_self_impact_full_run(make_deck):
...
def test_type24_impact_stability_dt09_variants(make_deck, istf, igap):
...
def test_notched_plate_crack_with_self_contact(make_deck):
    ...
    self-impact TYPE24 on the plate. As /FAIL/BIQUAD deletes elements,
