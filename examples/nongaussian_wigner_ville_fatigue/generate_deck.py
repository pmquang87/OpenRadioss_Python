...
def main():
    ...
    deck_writer.write_starter_from_port_lines(
        lines, os.path.join(here, "NONGAUSSIAN_WIGNER_VILLE_FATIGUE_0000.rad"), runname="NONGAUSSIAN_WIGNER_VILLE_FATIGUE")
    ...
    deck_writer.write_engine_from_port_lines(
        engine, os.path.join(here, "NONGAUSSIAN_WIGNER_VILLE_FATIGUE_0001.rad"))
