...
def qeph_post(thick, Nres, Mres, qres, st_amu, st_cspd, st_yld, st_fmat, vhg, dt, alive, plat, vqn, di, db, E, area, a_i, z1, corx, cory, x13, x24, y13, y24, mx13, mx23, mx34, my13, my23, my34, l13, l24, ll, lm):
    ...
    for e in range(n):
        ...
        if not plat[e]:
            ar0 = -z1[e] * (FL[e, 1, 0] * hpat0 + FL[e, 1, 1] * hpat1 + FL[e, 1, 2] * hpat2 + FL[e, 1, 3] * hpat3) + (cory[e, 0] * FL[e, 2, 0] + cory[e, 1] * FL[e, 2, 1] + cory[e, 2] * FL[e, 2, 2] + cory[e, 3] * FL[e, 2, 3]) + (ML3[e, 0, 0] + ML3[e, 0, 1] + ML3[e, 0, 2] + ML3[e, 0, 3])
            ar1 = z1[e] * (FL[e, 0, 0] * hpat0 + FL[e, 0, 1] * hpat1 + FL[e, 0, 2] * hpat2 + FL[e, 0, 3] * hpat3) - (corx[e, 0] * FL[e, 2, 0] + corx[e, 1] * FL[e, 2, 1] + corx[e, 2] * FL[e, 2, 2] + corx[e, 3] * FL[e, 2, 3]) + (ML3[e, 1, 0] + ML3[e, 1, 1] + ML3[e, 1, 2] + ML3[e, 1, 3])
            ar2 = corx[e, 0] * FL[e, 1, 0] + corx[e, 1] * FL[e, 1, 1] + corx[e, 2] * FL[e, 1, 2] + corx[e, 3] * FL[e, 1, 3] - (cory[e, 0] * FL[e, 0, 0] + cory[e, 1] * FL[e, 0, 1] + cory[e, 2] * FL[e, 0, 2] + cory[e, 3] * FL[e, 0, 3])
    ...
    for i in range(n):
        ...
        eint[i] += etmp1 + etmp2
        tesy = (ss1_v * dhg_0 + ss2_v * dhg_1) * t_i + (sf1_v * dhg_2 - sf2_v * dhg_3) * t_i * c6_i + 0.25 * (sc5_v * dhg_4 + sc6_v * dhg_5)
        ehour[i] += tesy
    dt_e = np.empty(n)
    for e in range(n):
