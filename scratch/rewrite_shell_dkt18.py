...
with open("pyradioss/elements/shell_dkt18.py", "r") as f:
    orig = f.read()

# Replace the forces function
forces_code = """
...
out_lines = []
for l in lines:
    if l.startswith("def forces"):
        break
    out_lines.append(l)

out_code = "\\n".join(out_lines) + "\\n" + forces_code + "    raise NotImplementedError("DKT18 implicit mass not implemented.")\n"

with open("pyradioss/elements/shell_dkt18.py", "w") as f:
    f.write(out_code)

print("Updated pyradioss/elements/shell_dkt18.py")
